...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .page-header-flex { flex-direction: column; gap: 10px; padding-top: 12px; margin-bottom: 16px; }
            .page-title { font-size: 1.6rem !important; }
            .page-subtitle { font-size: 0.9rem !important; }
            .white-card { padding: 20px 16px; border-radius: 16px; }
            .form-group { margin-bottom: 18px; }
            select, input { height: 50px; font-size: 15px; border-radius: 10px; }
            .btn-submit { height: 54px; font-size: 15px; border-radius: 10px; }
            .points-box { flex-direction: column; gap: 6px; text-align: center; }
            .back-link { font-size: 13px; padding: 7px 14px; }
        }
    </style>
</head>
<body>
